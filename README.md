...
View the [docs article](https://github.com/bshaffer/sfHadoriThemePlugin/blob/master/docs/01-Upgrade.md) For information on how to upgrade to 
Hadori from the original symfony admin generator.
